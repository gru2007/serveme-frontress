...
RSpec.describe 'the site API', type: :request do
               ...
               properties: {
                 reservation: {
                   ...
                   properties: {
                     ...
                     match_mode: { type: :string, nullable: true, enum: [ 'casual', 'ranked' ] },
                     match_config: { type: :string, nullable: true },
  ...
  path '/api/reservations' do
    get 'List reservations' do
      ...
      parameter name: :limit, in: :query, type: :integer, required: false, description: 'Limit number of results, maximum 100'
                 ...
                 reservations: {
                   ...
                   items: {
                     ...
                     properties: {
                       ...
                       disable_democheck: { type: :boolean, deprecated: true },
                       democheck_mode: { type: :string, enum: [ 'kick', 'warn', 'disable' ] },
                       connect_string: { type: :string, nullable: true },
                       stv_connect_string: { type: :string, nullable: true },
                       connect_url: { type: :string, nullable: true },
                       stv_connect_url: { type: :string, nullable: true }
                     }
                   }
                 }
               }
