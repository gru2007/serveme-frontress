  ...
  def shared_rcon_command(return_path)
    if reservation&.now?
      ...
      respond_to do |format|
        format.turbo_stream { render turbo_stream: turbo_stream.update("rcon_response", partial: "reservations/rcon_response", locals: { command: rcon_command, result: result }) }
