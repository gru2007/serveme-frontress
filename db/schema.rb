...
ActiveRecord::Schema[8.1].define(version: 2026_09_10_090000) do
  ...
  create_table "docker_host_setup_logs", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "docker_host_id", null: false
    t.integer "exit_status"
    t.text "output"
    t.string "step", null: false
    t.boolean "success", default: false, null: false
    t.datetime "updated_at", null: false
    t.index ["docker_host_id", "created_at"], name: "index_docker_host_setup_logs_on_docker_host_id_and_created_at"
    t.index ["docker_host_id"], name: "index_docker_host_setup_logs_on_docker_host_id"
  end

  create_table "docker_hosts", force: :cascade do |t|
    t.boolean "active", default: true
    t.boolean "build_host", default: false, null: false
  ...
  create_table "reservation_matches", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["reservation_id", "match_number"], name: "index_reservation_matches_on_reservation_id_and_match_number", unique: true
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.string "democheck_mode", default: "kick", null: false
  ...
  create_table "stac_detections", force: :cascade do |t|
    ...
    t.bigint "steam_uid", null: false
    t.datetime "updated_at", null: false
    t.index ["reservation_id"], name: "index_stac_detections_on_reservation_id"
